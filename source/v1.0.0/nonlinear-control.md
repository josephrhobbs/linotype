...
Contemporary research in aeronautical/astronautical engineering, autonomous systems, and robotics (particularly in reusable rocketry, self-driving cars, and bipedal/legged robotics) places an incredible emphasis on formal algorithms for __control__.  Fundamentally, the study of control, when applied to these fields, asks one of three questions.
...
Note: _this research area is titled_ Nonlinear Control _to indicate that the methods discussed are applied widely to a variety of problems, many of which are not linear.  The qualifier "nonlinear" indicates the generality of these formal methods, and is not used to the exclusion of control methods for linear systems._
...
[Reference: Dynamic Programming](nonlinear-control/dynamic-programming)
...
[Reference: Linear Quadratic Regulators](nonlinear-control/linear-quadratic-regulators)
...
[Reference: Lyapunov Analysis](nonlinear-control/lyapunov-analysis)
...
[Reference: SOS Relaxations](nonlinear-control/sum-of-squares-relaxations)
...
[Reference: Direct Transcription](nonlinear-control/direct-transcription)

[Reference: Direct Shooting](nonlinear-control/direct-shooting)

[Reference: Direct Collocation](nonlinear-control/direct-collocation)
